 ...
 */
@ApiModel
public class UserSpreadListRespBody {
    ...
    public List<UserSpreadListResp> getData() {
        return Data;
    }

    public void setData(List<UserSpreadListResp> data) {
        Data = data;
    }
