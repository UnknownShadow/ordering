...
<body>
    <div style="padding: 20px;">
        ...
        <span style="font-size: 24px;font-weight: 700;">意向代理</span>
...
<script type="text/javascript">
    $(function () {
        ...
        $(".contacted").click(function () {
            ...
            window.location.href="/contacted?id="+id+"&status=1";
        });


        $("#limit").change(function () {
            var limit = $(this).val();
            window.location.href="/apply_agent?page=1&limit="+limit;
        });
        var y = $("#y").val();
        if(y == 20){
    ...
    function mofen(page){
        ...
        window.location.href="/apply_agent?page="+page+"&limit="+limit;
    }
</script>
</html>
