...
<body>
    <div style="padding: 20px;">
        ...
        <span style="font-size: 24px;font-weight: 700;">实名认证记录</span>
        ...
        <div class="table-responsive">
            <table class="table table-hover">
                ...
                <c:forEach items="${authenticationEntities}" var="zhi">
                    <tr>
                        <td>${zhi.nickname}</td>
                        <td>${zhi.user_id}</td>
                        <td>${zhi.name}</td>
...
<script type="text/javascript">
    $(function () {
        ...
        $("#limit").change(function () {
            var limit = $(this).val();
            window.location.href="/authentication_record?page=1&limit="+limit;
        });
        var y = $("#y").val();
        if(y == 20){
    ...
    function mofen(page){
        ...
        window.location.href="/authentication_record?page="+page+"&limit="+limit;
    }
</script>
</html>
