...
<script type="text/javascript">
    ...
    function mofen(page){
        ...
        window.location.href="/club_management?page="+page+"&queryId="+user_id+"&queryStatus="+queryStatus+"&limit="+limit;
    }
    ...
    $(function () {
        ...
        $("#qurey").click(function () {
            ...
            var limit = $("#y").val();
            formSer.action="/club_management?page=1&queryId="+user_id+"&queryStatus="+queryStatus+"&limit="+limit;
            formSer.submit();
        });
        ...
        $("#limit").change(function () {
            ...
            var queryStatus = $("#findStatus").val();
            window.location.href="/club_management?page=1&queryId="+userId+"&queryStatus="+queryStatus+"&limit="+limit;
        });
        var y = $("#y").val();
        if(y == 20){
