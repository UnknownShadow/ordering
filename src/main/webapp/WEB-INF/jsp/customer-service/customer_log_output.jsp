...
<script type="text/javascript">
    ...
    $(function () {
        ...
        $("#findLog").click(function () {
            ...
            formSer.action="/log_output?page=1&user_id="+user_id+"&limit="+limit+"&status=1";
            formSer.submit();
        });
        ...
        $("#limit").change(function () {
            ...
            window.location.href="/log_output?page=1&user_id="+userId+"&limit="+limit+"&status=1";
        });
        var y = $("#y").val();
        if(y == 20){
    ...
    function mofen(page){
        ...
        window.location.href="/log_output?page="+page+"&user_id="+user_id+"&limit="+limit+"&status=1";
    }
