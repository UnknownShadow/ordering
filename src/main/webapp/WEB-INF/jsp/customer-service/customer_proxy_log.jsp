...
<script type="text/javascript">
    ...
    $(function () {
        ...
        $("#findLog").click(function () {
            ...
            if(!reg.test(user_id)){
               ...
               formSer.action="/proxy_log?page=1&user_id="+user_id+"&limit="+limit+"&status=1";
               formSer.submit();
            }
        });
        ...
        $("#limit").change(function () {
            ...
            window.location.href="/proxy_log?page=1&user_id="+userId+"&limit="+limit+"&status=1";
        });
        var y = $("#y").val();
        if(y == 20){
    ...
    function mofen(page){
        ...
        window.location.href="/proxy_log?page="+page+"&user_id="+user_id+"&limit="+limit+"&status=1";
    }
</script>
</html>
