...
<script>
    ...
    $(function () {
        $("#limit").change(function () {
            var limit = $(this).val();
            window.location.href="/integral_withdrawals?page=1&limit="+limit;
        });
    ...
    function mofen(page){
        ...
        window.location.href="/integral_withdrawals?page="+page+"&limit="+limit;
    }

    function passed(c) {
        var limit = document.getElementById("y").value;
        var page = document.getElementById("page").value;
        window.location.href="/integral_audit?byWho=3&status=4&ID="+c.id+"&trade_no="+c.alt+"&page="+page+"&limit="+limit;
    }
    function refuse(r) {
        var limit = document.getElementById("y").value;
        var page = document.getElementById("page").value;
        window.location.href="/integral_audit?byWho=3&status=0&ID="+r.id+"&trade_no="+r.alt+"&page="+page+"&limit="+limit;
    }
   /* function arrival(r) {
