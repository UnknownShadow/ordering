...
<script>
    ...
    function passed(c) {
       window.location.href="/integral_audit?byWho=5&status=1&ID="+c.id;
    }
    function refuse(r) {
        window.location.href="/integral_audit?byWho=5&status=0&ID="+r.id;
    }
    function arrival(r) {
        window.location.href="/integral_audit?byWho=5&status=2&ID="+r.id;
    }
</script>
</html>
