...
<body>
    ...
    <div style="padding: 20px;margin-bottom: 100px;">
        ...
        <label style="font-size: 20px;">付费数据详情</label><br>
        ...
        <div class="row">
            <div class="col-md-12 table-responsive">
                <table class="table table-hover">
                    ...
                    <c:forEach items="${wechatRechargeEntities}" var="zhi">
                        <tr>
                            <td>${zhi.created_date}</td>
                            <td>${zhi.user_id}</td>
                            <td>${zhi.nickname}</td>
                            <td>${zhi.money}</td>
...
<script type="text/javascript">
    ...
    function mofen(page){
        ...
        window.location.href="/payment_details?page="+page+"&limit="+y+"&chooseDate="+chooseDate;
    }
    ...
    $(function () {
        $("#detail_search").click(function () {
            ...
            if(chooseDate == ""){
                ...
                window.location.href="/payment_details?page=1&limit="+y+"&chooseDate="+chooseDate;
            }
        });
        ...
        $("#limit").change(function () {
            var limit = $(this).val();
            var chooseDate = $("#chooseDate").val();
            window.location.href="/payment_details?page=1&limit="+limit+"&chooseDate="+chooseDate;
        });
