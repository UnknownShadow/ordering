...
<body>
    ...
    <ul class="layui-nav" lay-filter="">
        <li class="layui-nav-item layui-this"><a href="/proxy_preview?page=1&limit=20&userId=">代理总览</a></li>
                        ...
                        <tr class="active success">
                           ...
                           <c:forEach items="${proxyLists}" var="zhi">
                                <tr>
                                    ...
                                    <td>
                                        <c:if test="${zhi.invite_code == 0}">无邀请码</c:if>
                                        <c:if test="${zhi.invite_code != 0}">${zhi.invite_code}</c:if>
                                    </td>
                                    <td>
