    ...
    <div style="padding: 20px;">
        ...
        <div class="row" style="margin-top: 20px;">
            <div class="col-md-3 pull-right" style="margin-bottom: 15px;">
                ...
                <a href="/message_system" style="margin-top: -35px;margin-left: -130px;" class="btn btn-primary">新增消息</a>
            </div>
        </div>
...
<script type="text/javascript">
    ...
    function mofen(page){
        ...
        window.location.href="/status_editor?page="+page+"&limit="+limit;
    }

    //消息查看
    function browse(e) {
        var id = $(e).attr('data-id');
        window.location.href="/message_browse?msg_id="+id;
    }
    ...
    function delet(d) {
        ...
        if (r==true){
            window.location.href="/deletByNotice?status=0&id="+id+"&limit="+limit;
        }else{
            return false;
        }
    }
    ...
    $(function () {
        $("#limit").change(function () {
            var limit = $(this).val();
            window.location.href="/status_editor?page=1&limit="+limit;
        });
