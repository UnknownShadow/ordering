...
<div class="content">
    <div style="z-index:999;height:65px;width:100%;background-color:white;margin-bottom: 10px;position:fixed;" >
        <div style="position: relative;height: 60px;width: 100%;background-color: white; border-bottom: 1px solid #afafaf;">
            ...
            <div style="margin-left: 38%;position: absolute;">
                ...
                <span style="position:absolute;top:25px;font-size:14px;font-family: Arial;color: #292929;">提现记录</span>
            </div>
        </div>
        <br>
    ...
    <table class="table table-hover lists" style="margin-top: 65px;"></table>    <!-- style="margin-top: 30%;" -->
</div>
   ...
   $(function(){
       ...
       $('.content').dropload({
           ...
           loadDownFn : function(me){
               ...
               $.ajax({
                   type: 'GET',
                   url: '/withdrawalsRecord?page='+page+'&size='+size,
                   dataType: 'json',
                       ...
                       if(arrLen > 0){
                           for(var i=0; i<arrLen; i++){
                               result += "<tr>"
                                   ...
                                   +"<span style='font-size: 13px;'>单号："+data[i].orderNum+"</span>"
                               +"<br>"
                               +"<span style='font-size: 10px;'>"
                                   +data[i].dateTime
                                   +"</span>"
                                   +"<td rowspan='2' style='vertical-align: middle;font-size: 12px;font-family: 黑体;'>￥"+data[i].WithdrawalLimit+"</td>"
                                   +"<td rowspan='2' style='vertical-align: middle;font-size: 14px;font-family: 黑体;'>"+data[i].verificationStatus+"</td>"
                               +"</tr>"
                               +"<tr></tr>";
                           }
                           // 如果没有数据
