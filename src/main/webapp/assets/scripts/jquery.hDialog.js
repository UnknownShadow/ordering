	...
	methods = {
        ...
        add: function (o,$this) { //显示弹框
			...
			if(o.closeHide != false){
				$obj.stop().append('<a id="HCloseBtn" title="关闭" style="background-color:'+closeBg+';"><span>×</span></a>').css({'position':'fixed','backgroundColor':o.boxBg,'top':t,'left':l,'margin':m,'zIndex':'100000'});
			}
