...
function Chart (options) {
	 ...
	 * 
	 * @param {Object} options The apiEntity options
	...
	/** 
	 * Create the Axis instances based on the apiEntity options
	 */
	function getAxes() {
...
Series.prototype = {
	...
	/**
	 * Some apiEntity objects, like marker, have a state value that depends on the base value
	 * @param {Object} props
	 */
